...
- Create the appropriate files, functions, and routes, where the format should be consistent with existing functions and routes
- Make sure the new survey loads and works properly on the frontend
