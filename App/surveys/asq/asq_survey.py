"""
Template for the functions related to ASQ/iHRV survey.
"""
import json
import os
...
def asq_load_questions(language: str = "EN") -> Tuple[Dict, Dict]:
    """
...
def asq_calculate_results(
    answers: list[float], language: str = "EN"
) -> tuple[str, Any, float]:
    """
    Function to calculate results for the iHRV survey
    ...
    asq_result = round(pipeline(answers, fs_multipliers_all)[0], 2)
    ...
    return results, metadata, asq_result
